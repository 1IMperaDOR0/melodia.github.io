    ...
    return (
        <>
            ...
            <div className="bg-[url('../assets/images/hero_section.jpg')] bg-center bg-cover h-[100vh] w-[100vw] text-white p-15 flex flex-col justify-center items-start">
                ...
                <p className="max-w-140 mb-5">
                    Gerencie sua conta, personalize seu perfil e aproveite ao máximo a experiência com o Melodia.
                </p>
                <button
                    onClick={scrollToLogin}
                    className="bg-[#7B00FF] hover:bg-[#5e00c4] px-6 py-3 rounded-full transition"
                >
                    ACESSE SUA CONTA
                </button>
            </div>
            ...
            <div
                ref={loginRef}
                className="bg-[#7B00FF] w-[100vw] text-white py-20 px-15 flex flex-col justify-center items-center text-center"
            >
            ...
            <div className="bg-[#FF2C63] w-full text-white py-20 px-15 flex flex-col justify-center items-center text-center overflow-hidden">
