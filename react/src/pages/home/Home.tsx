...
function Home() {
    ...
    return (
        <>
            ...
            <div className="bg-[#FF2C63] w-[100vw] text-white py-15 flex flex-col justify-center items-center text-center">
                <h1 className="text-7xl font-bold mb-5">TURNÊ MUSICAL</h1>
                <p className="w-200 mb-10">Prepare-se para viver a energia dos palcos com os maiores talentos da música! Junte-se a JESSICA, CAROL e MICHAEL em uma turnê inesquecível repleta de ritmo, emoção e muita vibração.</p>
                <div className="flex justify-between w-[100%] px-15">
                    <img src={jessica} className="h-[400px] w-[350px]"/>
                    <img src={carol} className="h-[400px] w-[350px]"/>
                    <img src={michael} className="h-[400px] w-[350px]"/>
                </div>
            </div>
            <div className="bg-[#7B00FF] w-[100vw] text-white py-15 pb-30 flex flex-col justify-center items-center text-center">
                <h1 className="text-7xl font-bold mb-5">NOSSAS ESTATÍSTICAS</h1>
                <p className="w-200 mb-30">Com talentos incríveis, eventos vibrantes e uma comunidade apaixonada, você está prestes a embarcar em uma experiência que vai movimentar todos os seus sentidos.</p>
                <div className="flex justify-between w-[100%] px-15">
            ...
            <div className="bg-[#FF2C63] w-[100vw] text-white py-45 flex flex-col justify-center items-center text-center">
                ...
                <p className="w-150 mb-10">Inscreva-se com seu e-mail e receba novidades exclusivas, lançamentos e experiências musicais direto na sua caixa de entrada.</p>
